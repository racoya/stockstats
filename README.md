...
2. [Strategy 00b: A Day in the Life of the Engine](docs/strategy/00b_system_lifecycle_day_in_the_life.md)
3. [Strategy 01: Project Vision & Scope](docs/strategy/01_project_vision_and_scope.md)
4. [Strategy 02: Data Architecture](docs/strategy/02_data_architecture.md) (TimescaleDB, Redis, Microsecond Aggregation)
5. [Strategy 03: Mathematical Models Summary](docs/strategy/03_mathematical_models.md)
6. [Strategy 04: Notification Engine](docs/strategy/04_notification_engine.md)
7. [Strategy 05: Execution and Risk](docs/strategy/05_execution_and_risk.md) (**Cancel-on-Disconnect**)
8. [Strategy 06: Internal Operations](docs/strategy/06_internal_operations.md) (**Poison Seed API Rotation**)
9. [Strategy 07: Frontend and Navigation](docs/strategy/07_frontend_and_navigation.md)
10. [Strategy 08: Backend Architecture](docs/strategy/08_backend_architecture.md)
11. [Strategy 09: Technology Stack](docs/strategy/09_technology_stack.md)
12. [Strategy 10: Manual Trading Phase 1](docs/strategy/10_phase_3_manual_trading.md) (**The Bootstrapped MVP**)
13. [Strategy 11: Database Schema & Ledgers](docs/strategy/11_database_schema_and_ledgers.md) (**Off-Site S3 WAL Backup**)
14. [Strategy 12: Execution Sprints and Tickets](docs/strategy/12_execution_sprints_and_tickets.md) (**The Master Task Tracker**)
15. [Strategy 13: Team Orientation and Training](docs/strategy/13_team_orientation_and_training.md)
16. [Strategy 14: Shadow Paper Trading](docs/strategy/14_paper_trading_and_forward_testing.md)
